     ...
     it("should return all users", function () {
         ...
         return chai.request(app)
             ...
             .then(_res => {
                 ...
                 res.should.have.status(200);
                 res.should.be.json;
                 res.body.user.should.have.lengthOf.at.least(1);

                 return User.countDocuments();
             })
             .then(count => {
                 res.body.user.should.have.lengthOf(count);
             });
     });
         ...
         return chai.request(app)
             ...
             .then(function (res) {
                 ...
                 res.body.users.forEach(function (user) {
                     review.should.be.a('object');
                     review.should.include.keys('_id', 'userName', 'password');
                 });
                 resUsers = res.body.users[0];

                 return User.findById(resUsers._id);
             })
             .then(beer => {
                 resUsers._id.should.equal(user._id.toString());
