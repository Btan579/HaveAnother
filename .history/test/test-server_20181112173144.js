        ...
        // });
            ...
            it('should post a new Review', function() {
                ...
                .then(function (res) {
                    ...
                    res.body.review.should.include.keys('id', 'beer', 'haveAnother', 'comment', 'user');
                    res.body.review.id.should.not.be.null;
                    res.body.review.beer.should.equal(testReview.beer);
                    res.body.review.haveAnother.should.equal(testReview.haveAnother);
                    res.body.review.comment.should.equal(testReview.comment);
                    res.body.review.user.should.equal(testReview.user);
                    
                    let savedBeer;
                    savedBeer = Beer
                        .findById(res.body.review.beer);
                ...
                //         // res.should.be.json;
                        ...
                        // res.body._id.should.not.be.null;
                        // res.body.beer.should.equal(testReview.beer);
                        // res.body.haveAnother.should.equal(testReview.haveAnother);
                        // res.body.comment.should.equal(testReview.comment);
                        // res.body.user.should.equal(testReview.user);
