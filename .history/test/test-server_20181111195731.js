            ...
            it('should post a new Review', function() {
                ...
                return chai.request(app)
                    ...
                    .then(function (res) {
                        ...
                        res.should.be.json;
                        res.body.should.be.a('object');
                        res.body.should.include.keys('_id', 'beer_id', 'haveAnother', 'comment', 'user_id');
                        res.body._id.should.not.be.null;
                        res.body.beer_id.should.equal(newReview.beer_id.toString());
                        res.body.haveAnother.should.equal(newReview.haveAnother);
                        res.body.comment.should.equal(newReview.comment);
                        res.body.user_id.should.equal(newReview.user_id.toString());
