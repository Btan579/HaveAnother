    ...
    describe("GET endpoint", function () {
        ...
        return chai.request(app)
            ...
            .then(function (res) {
                res.should.have.status(200);
                res.should.be.json;
                console.log("HERE HER HERE HER HERE");
                ...
                res.body.reviews.forEach(function (review) {
                    ...
                    review.should.include.keys('_id', 'beer', 'comment', 'user');
                });
                // just check one of the posts that its values match with those in db
                // and we'll assume it's true for rest
                resReviews = res.body.reviews[0];
                return Review.findById(resReviews._id);
            })
            .then(review => {
                resReview.id.should.equal(review._id);
