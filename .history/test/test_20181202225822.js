        ...
        //     });
            ...
            it("should return a specific review", function (done) {
                ...
                newReview.save((err, newReview) => {
                    ...
                    .end((err, res) => {
                        res.should.have.status(200);
                        console.log(res.body.reviews[0].beer);
                        res.body.should.be.a('object');
                        // res.body.reviews.beer.should.equal(newReview.beer);
                        // res.body.reviews.should.have.property('comment');
                        // res.body.reviews.should.have.property('haveAnother');
                        // res.body.reviews.should.have.property('user');
                        // res.body.reviews.should.have.property('_id').eql(newReview._id.toString());
                    done();
                    });
                });
            });
