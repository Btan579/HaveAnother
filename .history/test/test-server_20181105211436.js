...
describe('Reviews API resource', function () {
    ...
    describe('POST Endpoint', function() {
        // it('it should not POST a user that has a user name taken', function(done) {
        //      const newUser = new User({
        //         userName: faker.internet.userName(),
        //         password: faker.internet.password()
        //      });
        ...
        it('should POST a new user', function(done) {
            ...
            .end((err, res) => {
                ...
                res.body.property.userName.should.equal(newUser.userName);
                res.body.property.password.should.equal(newUser.password);
            done();
