...
const seedUserData = new Promise((resolve, reject) => {
    ...
    userDocs = User.insertMany(users);
});
...
const seedCategoriesData = new Promise((resolve, reject) => {
    ...
    categoryDocs = Category.insertMany(categories);
});
...
const seedStylesData = new Promise((resolve, reject) => {
    ...
    styleDocs = Style.insertMany(styles);
});
...
const seedBeerData = new Promise((resolve, reject) => {  
        ...
        beerDocs = Beer.insertMany(beers);
});
   
function seedReviewData() {
    console.info('seeding beer review data');
    for (let j = 0; j < beerDocs.insertedIds.length; j++) {
        for (let i = 0; i < 10; i++) {
            createReviewSeed(beerDocs.insertedIds[j]);
        }
    }
...
function getRandomStyle() {
    return styleDocs.insertedIds[Math.floor(Math.random() * styleDocs.insertedIds.length)];
}

function getRandomCategory() {
    return categoryDocs.insertedIds[Math.floor(Math.random() * categoryDocs.insertedIds.length)];
}

function getRandomBeer() {
    return beerDocs.insertedIds[Math.floor(Math.random() * beerDocs.insertedIds.length)];
}

function getRandomUser() {
    return userDocs.insertedIds[Math.floor(Math.random() * userDocs.insertedIds.length)];
}
