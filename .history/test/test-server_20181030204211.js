...
function getRandomStyle(styles) {
    return styles[Math.floor(Math.random() * styles.length)]._id.toString();
}

function getRandomCategory(categories) {   
    return categories[Math.floor(Math.random() * categories.length)]._id.toString();
}
