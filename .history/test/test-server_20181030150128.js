...
describe('GET endpoint', function() {
    ...
    beforeEach(function () {
        return seedReviewData(), seedBeerData(), seedStylesData(), seedCategoriesData();
     ...
     it("should return all categories", function () {
         ...
         return chai.request(app)
             ...
             .then(_res => {
                 ...
                 res.should.have.status(200);
                 res.should.be.json;
                 res.body.categories.should.have.lengthOf.at.least(1);

                 return Category.countDocuments();
             })
             .then(count => {
                 res.body.categories.should.have.lengthOf(count);
             });
     });
     ...
     it('should return Category with right fields', function () {
         ...
         return chai.request(app)
             ...
             .then(function (res) {
                 ...
                 resCategories = res.body.styles[0];
