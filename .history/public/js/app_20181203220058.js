...
const HTMLRenderer = {
    ...
    displayAllReviews: (data) => {
        ...
        for (let i = 0; i < data.reviews.length; i++) {
            $('.filtered-reviews').append('<div class="container"><div class="row"><div class="col-md-5 col-md-offset-6"><div class="filtered-review"><h6>Comment:</h6><p>' + data.reviews[i].comment +
                '</p><h6>have another: </h6><p>' + data.reviews[i].haveAnother +
                '</p><h6>Reviewer:</h6><p>' + data.reviews[i].user + '</p></div></div></div></div>')
