...
const EventListeners = {
    ...
    newReviewClick: function () {
        $(".new-review-link").on("click", function (event) {
            ...
            $(".review-submit-form").removeClass("hidden");

        });
    },

    newBeerClick: function () {
        $(".new-beer").on("click", function (event) {
            event.preventDefault();
    ...
    reviewCancel: function () {
        $("#cancel-review").on("click", function () {
            $("#new-review-submit-form").trigger('reset');
            // $(".review-submit-form").addClass("hidden");
        });

    },
    beerCancel: function () {
        $("#cancel-beer").on("click", function () {.
            $("#new-beer-form-submit").trigger('reset');
            $("#new-beer-form-submit").addClass("hidden");
        });
...
const App = {
    ...
    generateBeersDropDownNewReview: () => {
        ...
        $('#newBeerDrop, select[data-source]').each(function () {
            var $select = $(this);
            // $select.append('<option></option>');
            $.ajax({
                    method: "GET",
